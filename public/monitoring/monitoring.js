...
//	    var href= ev.currentTarget.attr('href');
	    var shref = $(this).attr('href');
            ...
            if (pos >= 0) {
		shref = shref.substring(pos + 1);		
	    }


	    $('#cpu-info').docview_ui_graphing('loadDataForHost', shref);
	    $('#disk-info').docview_ui_graphing('loadDataForHost', shref);
	    $('#mem-info').docview_ui_graphing('loadDataForHost', shref);
	    $('#df-util').docview_ui_graphing('loadDataForHost', shref);
